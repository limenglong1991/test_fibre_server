...
public:
    ...
    struct Config_t {
        ...
        MotorType_t motor_type = MOTOR_TYPE_GIMBAL;
    ...
    void init_virtual_motor();
    void run_virtual_motor_electrical(float v_alpha, float v_beta, float phase);
    void run_virtual_motor_mechanics(float ml);
    ...
    bool enqueue_voltage_timings(float v_alpha, float v_beta, float phase);
    ...
    Config_t& config_;
    virtual_motor_t virtual_motor;
    Axis* axis_ = nullptr; // set by Axis constructor

//private:

    uint16_t next_timings_[3] = {0};
